...
class CheckApiControllerTest {
    ...
    public CheckApiControllerTest(@Autowired MockMvc mvc) {
        this.mvc = mvc;
    ...
    void duplicate_check_empty() throws Exception {
        ...
        verify(signupService, times(0)).isAvailableEmail(anyString());
//        verify(signupService, times(0)).availableNickname(anyString(), anyString());
    ...
    class DuplicateNicknameTest {
        ...
        void duplicate_check_nickname_using() throws Exception {
            ...
            verify(signupService, times(0)).isAvailableEmail(EMAIL);
    ...
    class DuplicateEmailTest {
        ...
        void duplicate_check_email() throws Exception {
            when(signupService.isAvailableEmail(anyString())).thenReturn(true);
            ...
            verify(signupService, times(1)).isAvailableEmail(anyString());
            // verify(signupService, times(0)).availableNickname(anyString(), anyString());
        }
        ...
        void duplicate_check_email_fail() throws Exception {
            when(signupService.isAvailableEmail(anyString())).thenReturn(false);
