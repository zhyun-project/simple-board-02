...
class AuthenticationFilterTest {
    ...
    void attemptAuthentication_about_login() throws Exception {
        ...
        given(securityAuthenticationManager.authenticate(any(UsernamePasswordAuthenticationToken.class))).willReturn(doReturnAuthentication);
        ...
        // then
        then(securityAuthenticationManager).should(times(1)).authenticate(any(UsernamePasswordAuthenticationToken.class));
